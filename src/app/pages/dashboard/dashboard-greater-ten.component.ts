...
@Component({
  selector: 'app-dashboard-GREATER_TEN',
  template: `
    <general-orders-table 
      [cols]="cols" orderType="GREATER_TEN"
...
export class DashboardGreaterTenComponent implements OnInit, OnDestroy {
