...
@Component({
  ...
  template: `<general-orders-table [cols]="cols" orderType="FLASH" [listOfAllData]="lstOrders" (refresh)="getData()" ></general-orders-table>`,
  styleUrls: ['./dashboard.component.scss']
})
export class DashboardFlashComponent implements OnInit, OnDestroy {
  ...
  private searchData(){
    ...
    this._dS.getOrders20JSON('FLASH').subscribe(
    (rta:any) => {
