...
@Component({
  selector: 'app-dashboard-canceled-subscription',
...
export class DashboardCanceledSubscriptionComponent implements OnInit, OnDestroy {
  ...
  private searchData(){
    ...
    this.promise = this._dS.getOrders20JSON('CANCELED_SUBSCRIPTION').subscribe(
    (rta:any) => {
