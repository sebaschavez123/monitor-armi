...
@Component({
  selector: 'app-dashboard-canceled-provider',
...
export class DashboardCanceledProviderComponent implements OnInit, OnDestroy {
  ...
  private searchData(){
    ...
    this.promise = this._dS.getOrders20JSON('CANCELED_PROVIDER').subscribe(
    (rta:any) => {
