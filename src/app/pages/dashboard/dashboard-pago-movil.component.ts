...
@Component({
  ...
  template: `<general-orders-table [cols]="cols" orderType="PAGO_MOVIL" [listOfAllData]="lstOrders" (refresh)="getData()" ></general-orders-table>`,
  styleUrls: ['./dashboard.component.scss']
})
export class DashboardPagoMovilComponent implements OnInit, OnDestroy {
  ...
  private searchData(){
    ...
    this._dS.getOrders20JSON('PAGO_MOVIL').subscribe(
    (rta:any) => {
