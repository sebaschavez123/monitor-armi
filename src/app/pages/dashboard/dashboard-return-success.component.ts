...
@Component({
  selector: 'app-dashboard-RETURN',
  template: `
    <general-orders-table 
      [cols]="cols" orderType="RETURN"
...
export class DashboardReturnSuccessComponent implements OnInit, OnDestroy {
